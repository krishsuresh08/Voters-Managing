...
export default function EmployeeForm() {
  ...
  const PostData = {
    emp_id:"", emp_name: EmployeeName, email: Email, phone_number : PhoneNumber, password: Password, created_by: localStorage.getItem("Name"),user_type:"", created_at: Date.now(), modified_on: Date.now()
  }
  ...
  return (
    <div style={{ height:"100vh"}}>
        <Grid container sx={{p:2, } } rowGap={3} columnGap={5} paddingLeft={5} paddingTop={3} justifyContent="center">
          <Grid item xs={12}>
